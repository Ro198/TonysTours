...
@Component({
  selector: 'page-vehiculosrentadosodyssey',
  templateUrl: 'vehiculosrentadosodyssey.html',
})
export class VehiculosrentadosodysseyPage {
  ...
  listar_rentas() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosOdyssey().subscribe(
          data => {
