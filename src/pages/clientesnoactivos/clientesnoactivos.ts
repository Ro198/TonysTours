...
@Component({
  selector: 'page-clientesnoactivos',
  templateUrl: 'clientesnoactivos.html',
})
export class ClientesnoactivosPage {
  ...
  listar_clientes()
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.ClienteService.listarClienteNoActivo().subscribe(
          data => {
