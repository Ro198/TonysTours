...
@Component({
  selector: 'page-pvehiculocinco',
  templateUrl: 'pvehiculocinco.html',
})
export class PvehiculocincoPage {
  ...
  listar_vehiculos() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosEnServicioCinco().subscribe(
          data => {
