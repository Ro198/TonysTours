...
@Component({
  selector: 'page-vehiculosrentadossienna',
  templateUrl: 'vehiculosrentadossienna.html',
})
export class VehiculosrentadossiennaPage {
  ...
  listar_rentas() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosSienna().subscribe(
          data => {
