...
@Component({
  selector: 'page-clienteactivomes',
  templateUrl: 'clienteactivomes.html',
})
export class ClienteactivomesPage {
              ...
              buttons: [
                  {
                    ...
                    handler: () => {
                      this.navCtrl.setRoot(ClientesactivosPage)
                      //this.dismiss()
                    }
                  }]
             });
