...
@Component({
  selector: 'page-pvehiculocatorce',
  templateUrl: 'pvehiculocatorce.html',
})
export class PvehiculocatorcePage {
  ...
  listar_vehiculos() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosEnServicioCatorce().subscribe(
          data => {
