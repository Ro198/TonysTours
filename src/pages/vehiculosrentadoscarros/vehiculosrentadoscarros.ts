...
@Component({
  selector: 'page-vehiculosrentadoscarros',
  templateUrl: 'vehiculosrentadoscarros.html',
})
export class VehiculosrentadoscarrosPage {
  ...
  listar_rentas() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosCarros().subscribe(
          data => {
