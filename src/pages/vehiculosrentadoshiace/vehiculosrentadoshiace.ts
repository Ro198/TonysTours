...
@Component({
  selector: 'page-vehiculosrentadoshiace',
  templateUrl: 'vehiculosrentadoshiace.html',
})
export class VehiculosrentadoshiacePage {
  ...
  listar_rentas() 
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.VehiculoService.listarVehiculosHiace().subscribe(
          data => {
