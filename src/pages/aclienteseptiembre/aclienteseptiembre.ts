...
@Component({
  selector: 'page-aclienteseptiembre',
  templateUrl: 'aclienteseptiembre.html',
})
export class AclienteseptiembrePage {
  ...
  listar_clientes()
  {
         this.loading =this.loadingCtrl.create({
           ...
           this.ClienteService.ClienteMesSeptiembre().subscribe(
          data => {
